...
function menu_alter() {
	...
	#adminmenu .menu-icon-feedback:hover div.wp-menu-image, #adminmenu .menu-icon-feedback.wp-has-current-submenu div.wp-menu-image, #adminmenu .menu-icon-feedback.current div.wp-menu-image { background: url("' .RADIUM_FORMS_PLUGIN_URL . 'images/grunion-menu-hover.png") no-repeat 7px 7px !important; }
	#adminmenu .menu-icon-feedback div.wp-menu-image, #adminmenu .menu-icon-feedback div.wp-menu-image, #adminmenu .menu-icon-feedback div.wp-menu-image { background: url("' . RADIUM_FORMS_PLUGIN_URL . 'images/grunion-menu.png") no-repeat 7px 7px !important; }
	.grunion-menu-button { background: url("' . RADIUM_FORMS_PLUGIN_URL . 'images/grunion-form.png") no-repeat; width: 13px; height: 13px; display: inline-block; vertical-align: middle; ) }
	@media only screen and (-moz-min-device-pixel-ratio: 1.5), only screen and (-o-min-device-pixel-ratio: 3/2), only screen and (-webkit-min-device-pixel-ratio: 1.5), only screen and (min-device-pixel-ratio: 1.5) {
	    #adminmenu .menu-icon-feedback:hover div.wp-menu-image, #adminmenu .menu-icon-feedback.wp-has-current-submenu div.wp-menu-image, #adminmenu .menu-icon-feedback.current div.wp-menu-image { background: url("' .RADIUM_FORMS_PLUGIN_URL . 'images/grunion-menu-hover-2x.png") no-repeat 7px 7px !important; background-size: 15px 16px !important; }
		#adminmenu .menu-icon-feedback div.wp-menu-image, #adminmenu .menu-icon-feedback div.wp-menu-image, #adminmenu .menu-icon-feedback div.wp-menu-image { background: url("' . RADIUM_FORMS_PLUGIN_URL . 'images/grunion-menu-2x.png") no-repeat 7px 7px !important; background-size: 15px 16px !important; }
	    .grunion-menu-button { background-image: url("' . RADIUM_FORMS_PLUGIN_URL . 'images/grunion-form-2x.png"); background-size: 13px 12px !important; vertical-align: bottom; }
	}
	</style>';
}
...
function grunion_media_button( ) {
	...
	$title = esc_attr( __( 'Add a custom form', 'radium' ) );
	$plugin_url = esc_url( RADIUM_FORMS_PLUGIN_URL );
...
function display_form_view() {
	require_once RADIUM_FORMS_PLUGIN_DIR . 'form-view.php';
	exit;
}
...
#icon-edit.icon32-posts-feedback, #icon-post.icon32-posts-feedback { background: url("<?php echo RADIUM_FORMS_PLUGIN_URL; ?>images/grunion-menu-big.png") no-repeat !important; }
@media only screen and (-moz-min-device-pixel-ratio: 1.5), only screen and (-o-min-device-pixel-ratio: 3/2), only screen and (-webkit-min-device-pixel-ratio: 1.5), only screen and (min-device-pixel-ratio: 1.5) {
    #icon-edit.icon32-posts-feedback, #icon-post.icon32-posts-feedback { background: url("<?php echo RADIUM_FORMS_PLUGIN_URL; ?>images/grunion-menu-big-2x.png") no-repeat !important; background-size: 30px 31px !important; }
}
...
function grunion_ajax_shortcode() {
	...
	if ( is_array( $_POST['fields'] ) ) {
		...
		foreach ( $fields as $field ) {
			...
			$field_shortcodes[] = new Radium_Contact_Form_Field( $field_attributes );
		}
	}

	$grunion = new Radium_Contact_Form( $attributes, $field_shortcodes );
...
function grunion_ajax_shortcode_to_json() {
	...
	$grunion = Radium_Contact_Form::$last;
